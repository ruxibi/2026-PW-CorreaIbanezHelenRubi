...
console.log("Aplicando funcion Find  en talleres")
...
console.log("Aplicando Reduce en talleres")
...
console.log("Aplicando Filter mas map ")
const cdisponente = talleres
filter((t) =>t.inscritos < t.cupo)
.map((t) => t.nombre); 
console.log(cdisponente); 